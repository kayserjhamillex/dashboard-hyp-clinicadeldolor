...
@Component({
  selector: 'app-especialista-edit-doctor',
  standalone: true,
  imports: [],
  templateUrl: './especialista-edit-doctor.component.html',
  styleUrl: './especialista-edit-doctor.component.css'
})
export default class EspecialistaEditDoctorComponent implements OnInit {
